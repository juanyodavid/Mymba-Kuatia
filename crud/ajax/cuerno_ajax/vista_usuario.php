...
if($action == 'ajax'){
	...
	$tables="cuerno";
	$campos="*";
	$sWhere=" cuerno.tipo_cuerno LIKE '%".$query."%'"; // los ampersand hacen que sea una busqueda en toda la palabra y no solo el inicio
	$sWhere.=" order by cuerno.".$test;
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						...
						<th class='text-center'><a href="lote.php?orden=nombre_lote" >Cuerno</a></th>
				...
				<tbody>	
						...
						while($row = mysqli_fetch_array($query)){	
							$venta_id=$row['id_cuerno'];
							$nombre=$row['tipo_cuerno'];
