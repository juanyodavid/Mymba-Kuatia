<?php
	...
	$ind = mysqli_real_escape_string($con,(strip_tags($_POST["ind_edit"],ENT_QUOTES)));
	$anim = mysqli_real_escape_string($con,(strip_tags($_POST["anim_edit"],ENT_QUOTES)));
	$id=intval($_POST['edit_id']);
	// UPDATE data into database
    $sql = "UPDATE sanitacion SET producto ='".$producto ."',obser_sanit='".$obs ."',fecha_sanit='".$fecha ."',dosis='".$dosis ."',indicacion='".$ind ."',id_animal='".$anim ."' WHERE id_sanitacion='".$id."' ";
