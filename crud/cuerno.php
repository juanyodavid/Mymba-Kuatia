...
<body>
	...
	<!-- Edit Modal HTML -->
	<?php include("html/cuerno_crud/modal_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("html/cuerno_crud/modal_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php include("html/cuerno_crud/modal_delete.php");?>
	<script src="js/cuerno_script.js"></script>
