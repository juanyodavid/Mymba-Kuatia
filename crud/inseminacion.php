...
<body>
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						...
						<h2 >Tabla: <b>Inseminaciones</b></h2>	
					</div>						
					<div class="col-sm-6">
	...
	<!-- Edit Modal HTML -->
	<?php include("html/inseminacion_crud/modal_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("html/inseminacion_crud/modal_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php include("html/inseminacion_crud/modal_delete.php");?>
	<script src="js/inseminacion_script.js"></script>
