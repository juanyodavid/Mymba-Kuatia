$(function() {
		...
		function load(page){// significa que se ejecuta al ser llamado este archivo ya que se ejecuta la funcion
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'ajax/det_venta_ajax/vista_usuario.php',
				data: parametros,
		...
		$('#editProductModal').on('show.bs.modal', function (event) {
		  ...
		  $('#fact_edit').val(fact)
		  var prec= button.data('prec') 
		  $('#prec_edit').val(prec)
		  var peso= button.data('peso') 
		  $('#animal_edit').val(peso)
		...
		$( "#edit_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/det_venta_ajax/editar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		$( "#add_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/det_venta_ajax/guardar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
		...
		$( "#delete_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/det_venta_ajax/eliminar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
