$(function() {
		...
		function load(page){// significa que se ejecuta al ser llamado este archivo ya que se ejecuta la funcion
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'ajax/lote_ajax/vista_usuario.php',
				data: parametros,
		...
		$('#editProductModal').on('show.bs.modal', function (event) {
		  ...
		  var lote_add = button.data('lote_add') // crea la variable lote_add y la informacion lo guarda en el boton.data (LOTE_ADD)
		  $('#lote_edit').val(lote_add) //al editar en la posicion de lote add va a aparecer la que se cargo en lote_add
		...
		$( "#edit_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/lote_ajax/editar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		$( "#add_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/lote_ajax/guardar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
		...
		$( "#delete_product" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "ajax/lote_ajax/eliminar_producto.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
