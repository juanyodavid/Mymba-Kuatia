...
if($action == 'ajax'){
	...
	$tables="principal";
	$campos="*";
	$sWhere="id_animal LIKE '%".$query."%'";
	$sWhere1="carimbo LIKE '%".$query1."%'";
	$sWhere2="id_marca LIKE '%".$query2."%'";
	$sWhere3="sexo LIKE '%".$query3."%'";
	$sWhere.=" order by principal.".$orden;
	...
	$query = mysqli_query($con,"SELECT $campos FROM  $tables where $sWhere1 AND $sWhere2 AND $sWhere3 AND $sWhere LIMIT $offset,$per_page");
