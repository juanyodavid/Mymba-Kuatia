	...
	<div class="menu-wrap">
		<nav class="menu">
			<div class="icon-list">
				...
				<a href="compra.php" class="nounderline"><i class="fa fa-fw fa-gavel"></i><span>Compras</spam></a>
		...
		<div class="morph-shape" id="morph-shape" data-morph-open="M-7.312,0H15c0,0,66,113.339,66,399.5C81,664.006,15
			...
			<svg xmlns="#" width="100%" height="100%" viewBox="0 0 100 800" preserveAspectRatio="none">
				<path d="M-7.312,0H0c0,0,0,113.839,0,400c0,264.506,0,400,0,400h-7.312V0z"/></svg>
		</div>
	</div>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<button class="menu-button" id="open-button"><i class="fa fa-list" aria-hidden="true"></i></button>

						<h2 >Tabla: <b>Animales</b></h2>	
					</div>						
					<div class="col-sm-6">
						<a href="../cerrar.php" class="btn btn-danger"><i class="material-icons">power_settings_new</i> <span>Cerrar sesión</span></a>
						<a href="../principal.php" class="btn btn-warning" ><i class="material-icons">keyboard_backspace</i> <span>Atrás</span></a>
			...
			<div class='col-sm-3 pull-right'>
				<div id="custom-search-input">
					...
					<div class="input-group col-md-12">
                        <input type="text" class="form-control" placeholder="Buscar por Carimbo"  id="a" onkeyup="load(1);" />
                        <button class="btn btn-info" type="button" onclick="load(1);"><i class="fa fa-fw fa-search"></i></button>
                    </div>
					<div class="input-group col-md-12">
                        <input type="text" class="form-control" placeholder="Buscar por Marca"  id="b" onkeyup="load(1);" />
                        <button class="btn btn-info" type="button" onclick="load(1);"><i class="fa fa-fw fa-search"></i></button>
                    </div>
					<div class="input-group col-md-12">
                        <input type="text" class="form-control" placeholder="Buscar por Sexo"  id="c" onkeyup="load(1);" />
                        <button class="btn btn-info" type="button" onclick="load(1);"><i class="fa fa-fw fa-search"></i></button>
                    </div>
                </div>
			</div>
